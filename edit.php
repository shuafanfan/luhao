...
$row=$db->row("select * from t_luhao_case_offlist_setup where id={:id}",array('id'=>$_GET['id']));

if($_POST['submit']=='确认修改')
{
$args['备注']=$_POST['info'];
$args['OA阶段代理费标准']=$_POST['fee'];
$dr=$db->exec("update t_luhao_case_offlist_setup set type={:type},args={:args} where id={:id}",
			array(
				'type'=>$_POST['type'],
	...
	<table class="toolbar">
		...
		<form action="" method="post">
			...
			<tr align="center">
				...
				<td><input type="text" name="type" value="<?php echo $row['type'] ?>" style="width:98%" required></td>
			</tr>			
			<tr align="center">
				<td style="width:60px;" align="right">备注<span style="color:red;">*</span></td>
				<td><textarea name="info" id="" style="width:98%" required ><?php echo json_decode($row['args'], true)['备注'] ?></textarea></td>
			</tr>
